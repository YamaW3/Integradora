...
<head>
    ...
    <title> Free | HelPath </title>
</head>
<body>
    <nav class="navbar">  
        <div> <img src="../imagenes/cielo.jpg" width="150"> </div>  
        <ul class="nav-links" >  
            <li><a href="../html/index.html"> Home </a></li>  
            <li><a href="../html/index.html"> About </a></li>
            <li><a href="NotIndex.php"> Consult </a></li>  
            <li><a href="../html/index.html"> Pricing </a></li>  
            <li><a href="../html/index.html"> Support </a></li>  
        </ul>  
    </nav> 
